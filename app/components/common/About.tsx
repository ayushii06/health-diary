  ...
  return (
    <>
      <div className="text-center py-8 px-4 sm:px-8">
        ...
        <div className="md:max-w-5xl text-center mx-auto font-light text-gray-600 text-sm sm:text-base leading-relaxed px-4 sm:px-10">
        ...
        <div className="overflow-x-auto mt-12 px-2">
          <table className="w-full sm:w-[90%] md:w-[70%] mx-auto border-2 mb-4 text-left rounded-2xl border-gray-700">
            <thead>
              <tr>
                ...
                <th className="border-b-2 border-gray-700 p-4">
            ...
            <tbody>
              <tr>
                ...
                <td className="border-b border-gray-500 p-4">Less than 140</td>
              </tr>
              <tr>
                ...
                <td className="border-b border-gray-500 p-4">140-199</td>
              </tr>
              <tr>
                <td className="border-b border-r border-gray-500 p-4">
                  Diabetes
                ...
                <td className="border-b border-gray-500 p-4">200 or higher</td>
              </tr>
            </tbody>
          </table>
        </div>
        <p className="text-light text-gray-600 text-sm sm:text-base mt-2">
          * Fasting = after 8 hours without food
        </p>
      </div>

      <div className="flex flex-col sm:flex-row flex-wrap justify-center items-start gap-10 sm:gap-20 my-12 mx-6 sm:mx-12">
        <div className="border-2 border-gray-700 p-6 w-full sm:w-[45%] lg:w-[35%]">
          ...
          <ul className="ml-6 my-6 list-decimal text-md font-normal">
      ...
      <div className="font-bold text-center my-12 text-2xl sm:text-3xl">
        Food To Eat
      </div>

      <div className="flex flex-wrap justify-center sm:justify-evenly items-start gap-6 sm:gap-10 my-12 mx-6 sm:mx-12">
        {[healthy1, healthy2, healthy3, healthy4, healthy5].map((img, i) => (
          <div key={i} className="w-[80%] sm:w-[300px]">
            <Image
              src={img}
              width={300}
              height={200}
            ...
            <p className="text-sm sm:text-base mt-2">
              {
                [
                  "Palak, Methi, Bathua, Lauki, Tinda, Tori, Bhindi, Beans, Broccoli, Cabbage, Cauliflower, Carrot, Beetroot",
                  "Brown rice, Daliya, Jowar, Bajra, Ragi, Oats, whole wheat, ragi flour",
      ...
      <div className="flex flex-wrap justify-center sm:justify-evenly items-start gap-6 sm:gap-10 py-12 mx-6 sm:mx-12">
        {[unhealty2, unhealty1, unhealty3].map((img, i) => (
          <div key={i} className="w-[80%] sm:w-[300px] mx-auto mb-8">
            <Image
              src={img}
              width={400}
              height={200}
            ...
            <p className="text-sm sm:text-base mt-2">
              {
                [
                  "Samosa, pakora, chips, puri, bhatura, Maida",
                  "Processed Foods (Pizza, Burger, etc.), Soft Drinks (Pepsi, Coca-Cola), Fast Food",
